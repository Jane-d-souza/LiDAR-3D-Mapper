...
//Jane Student number: 400366436
//Jane's onbaord LEDs -> 2nd LSD(3)
//Meaursement status: PF0 -D4
//Additonal status: PF4 -D3 (when it turns ccw)
...
void onboardLEDs_Init(void){
  ...
  GPIO_PORTN_AMSEL_R &= ~0x01;     								// disable analog functionality on PN0,PN1
